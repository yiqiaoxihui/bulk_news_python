...
def swarm_interestingengineering(begin_page,end_page,article_typ):
	# fw=open('2','w')
	file_name='interestingengineering_'+article_typ+".txt"
	dic={}
	dic['status']=1
	...
	for i in range(begin_page,end_page+1):
		time.sleep(2)
		try:
			url = 'https://interestingengineering.com/'+article_typ+'?page='+str(i)
			print url
...
if __name__ == "__main__":
	swarm_interestingengineering(int(sys.argv[1]),int(sys.argv[2]),sys.argv[3])
